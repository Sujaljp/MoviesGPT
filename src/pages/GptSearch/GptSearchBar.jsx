...
const GptSearchBar = () => {
  ...
  const handleSearch = async () => {
    ...
    const result = "Coco, Kantara, Interstellar, Life of Pi, Five Feet Apart";
  ...
  return (
    <div className="pt-[20vh]  md:pt-[20vh] p-4  md:p-8">
      <form
        className=" bg-black/85 p-2 md:p-4 w-full sm:w-2/3 md:w-1/2 rounded-lg grid grid-cols-12 gap-2 md:gap-4  sm:mx-auto font-medium"
